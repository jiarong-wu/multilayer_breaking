...
#line 1 "/home1/06342/tg856416/basilisk/src/common.h"
#include <stdlib.h>
#include <stdio.h>
#include <stddef.h>
#include <stdbool.h>
...
#line 108 "/home1/06342/tg856416/basilisk/src/common.h"
...
static void * pmfunc_alloc (pmdata * d, size_t size,
       ...
       char c)
{
  if (!(d != NULL)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 183, "d != NULL");
  OMP (omp critical)
  {
...
{
  if (!(t->stack.len > 0)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 455, "t->stack.len > 0");
...
static void end_trace (const char * func, const char * file, int line)
{
  ...
  if (!(Trace.stack.len >= 2*sizeof(double))) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 559, "Trace.stack.len >= 2*sizeof(double)");
...
#define prof_start(name)\
  if (!(!in_prof)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 669, "!in_prof"); in_prof = true;\
  prof_start = MPI_Wtime();\

#line 671

#define prof_stop()\
  if (!(in_prof)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 673, "in_prof"); in_prof = false;\
  _prof = MPI_Wtime();\
...
{ trace ("mpi_all_reduce0", "/home1/06342/tg856416/basilisk/src/common.h", 685);
  { int _ret =  MPI_Allreduce (sendbuf, recvbuf, count, datatype, op, comm); end_trace("mpi_all_reduce0", "/home1/06342/tg856416/basilisk/src/common.h", 686);  return _ret; }
 end_trace("mpi_all_reduce0", "/home1/06342/tg856416/basilisk/src/common.h", 687); }
#define mpi_all_reduce(v,type,op) {\
...
#line 828 "/home1/06342/tg856416/basilisk/src/common.h"
...
static void set_fpe (void) {
  ...
  if (!(sizeof (int64_t) == sizeof (double))) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 838, "sizeof (int64_t) == sizeof (double)");
...
OMP(omp declare reduction (+ : coord :
      ...
      omp_out.y += omp_in.y,
      omp_out.z += omp_in.z))
#line 922 "/home1/06342/tg856416/basilisk/src/common.h"
...
#line 1 "/home1/06342/tg856416/basilisk/src/grid/boundaries.h"
...
#line 47 "/home1/06342/tg856416/basilisk/src/grid/boundaries.h"
typedef struct {
  Boundary parent;
  int d;
} BoxBoundary;
#line 1014 "/home1/06342/tg856416/basilisk/src/common.h"



typedef struct {

#line 1019 "/home1/06342/tg856416/basilisk/src/common.h"
...
#line 18 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
...
#line 17 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#endif
#line 1017 "/home1/06342/tg856416/basilisk/src/common.h"
...
#line 1160
 {
      if (!(s->i >= 0)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 1161, "s->i >= 0");
      v.x = *s++;
    }
#line 1160
 {
...
#line 1191
 {
      if (!(v->x.i >= 0)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 1192, "v->x.i >= 0");
      t.x = *v++;
    }
#line 1191
 {
      if (!(v->y.i >= 0)) qassert ("/home1/06342/tg856416/basilisk/src/common.h", 1192, "v->x.i >= 0");
      t.y = *v++;
    }}
...
#line 1296 "/home1/06342/tg856416/basilisk/src/common.h"
...
#line 1 "/home1/06342/tg856416/basilisk/src/grid/layers.h"
...
#line 1495 "/home1/06342/tg856416/basilisk/src/common.h"
...
#line 1 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
#line 16 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
typedef struct {
  Grid g;
  char ** d;
} Multigrid;
...
#line 49 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
static size_t _size (size_t l)
{
  size_t n = (1 << l) + 2*2;
  return sq(n);
}
#line 62 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
#define data(k,l,m)\
...
#line 89 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 117 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
#define depth() (grid->depth)
#line 136 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
#define fine(a,k,l,m)\
  ((double *)\
...
#line 191 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#define refine_cell(...) do {\
  ...
  if (!(0)) qassert ("/home1/06342/tg856416/basilisk/src/grid/multigrid.h", 249, "0");\
} while (0)\
...
#line 1 "/home1/06342/tg856416/basilisk/src/grid/foreach_cell.h"
#line 66 "/home1/06342/tg856416/basilisk/src/grid/foreach_cell.h"
...
#line 254 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 320 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 381 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
#if TRASH
# undef trash
...
#line 1 "/home1/06342/tg856416/basilisk/src/grid/neighbors.h"
#line 17 "/home1/06342/tg856416/basilisk/src/grid/neighbors.h"
...
#line 387 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 427 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 532 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 568 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
 {
   scalar s, sb;
...
#line 703 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
void free_grid (void)
{
  if (!grid)
    return;
...
void init_grid (int n)
{
  ...
  mpi_boundary_new();
#line 748 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 786 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 790 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
  ...
  if (point.j < 2 || point.j >= point.n + 2)
    return point;
#line 821 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
  point.level = depth();
  return point;
}

#line 1 "grid/multigrid-common.h"
#line 1 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"


#line 1 "grid/cartesian-common.h"
#line 1 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
#line 1 "grid/events.h"
#line 1 "/home1/06342/tg856416/basilisk/src/grid/events.h"
...
void event_register (Event event) {
  if (!(Events)) qassert ("/home1/06342/tg856416/basilisk/src/grid/events.h", 87, "Events");
  if (!(!event.last)) qassert ("/home1/06342/tg856416/basilisk/src/grid/events.h", 88, "!event.last");
  int n = 0, parent = -1;
  for (Event * ev = Events; !ev->last; ev++) {
    if (!strcmp (event.name, ev->name)) {
      if (!(parent < 0)) qassert ("/home1/06342/tg856416/basilisk/src/grid/events.h", 92, "parent < 0");
      parent = n;
    }
    n++;
  }
...
#line 131 "/home1/06342/tg856416/basilisk/src/grid/events.h"
...
double dtnext (double dt)
{
  if (tnext != HUGE && tnext > t) {
    ...
    if (!(n < INT_MAX)) qassert ("/home1/06342/tg856416/basilisk/src/grid/events.h", 245, "n < INT_MAX");
    if (n == 0)
      dt = tnext - t;
    else {
...
#line 2 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
#line 1 "grid/fpe.h"
#line 1 "/home1/06342/tg856416/basilisk/src/grid/fpe.h"
...
#line 37 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"

#define end_foreach_face()

#line 1 "grid/stencils.h"
#line 1 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
#line 18 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
...
#line 43 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
typedef struct {
  const char * fname;
  int line;
  int first;
...
#line 59 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
...
#line 127 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
...
#line 398
 ...
 strongif (baseblock) for (scalar d = *baseblock, *_i17 = baseblock; ((scalar *)&d)->i >= 0; d = *++_i17)
  ...
  if (flux) {
#line 436 "/home1/06342/tg856416/basilisk/src/grid/stencils.h"
    boundary_face (listf);
    {
#line 437
...
#line 41 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
scalar new_block_scalar (const char * name, const char * ext, int block)
{
 ...
 init_block_scalar (sb, name, ext, n, block);
  ...
  s = (scalar){nvar};
  if (!(nvar + block <= _NVARMAX)) qassert ("/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 83, "nvar + block <= _NVARMAX");
...
#line 191
 {
    ...
    t.y.x = t.x.y;
#line 211 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
  init_tensor (t, NULL);
  return t;
}
...
void scalar_clone (scalar a, scalar b)
{
  ...
  if (!(_attribute[b.i].block > 0 && _attribute[a.i].block == _attribute[b.i].block)) qassert ("/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 256, "b.block > 0 && a.block == b.block");
...
void free_solver ()
{
  if (!(_val_higher_dimension == 0.)) qassert ("/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 343, "_val_higher_dimension == 0.");
...
void boundary_internal (scalar * list, const char * fname, int line)
{ trace ("boundary_internal", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 416);
  if (list == NULL)
    { ; end_trace("boundary_internal", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 418);  return; }
  scalar * listc = NULL;
  vectorl listf = {NULL};
  bool flux = false;
...
#line 441
 ...
 end_trace("boundary_internal", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 450); }
...
#line 465 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 470 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", .line = 619,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 619 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
 {
    bool inside = true;
    coord o = {x,y,z};
    {
 ...
 inside = false;}
    IF (inside) {
      ...
      _stencil_fprintf (__FILE__,__LINE__,p.fp, "%g %g\n%g %g\n%g %g\n%g %g\n%g %g\n\n",
        ...
        x + Delta, y - Delta,
        x - Delta, y - Delta);
#line 651 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
    }
...
#line 663 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 697 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
  ...
  fputc ('\n', fp);
#line 730 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
    for (int k = -2; k <= 2; k++)
      for (int l = -2; l <= 2; l++) {
...
#line 760 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
  fclose (fp);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 801 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
#line 829 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
{ trace ("interpolate", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 833);
  scalar v = p.v;
  boundary_internal ((scalar *)(((scalar []){v,{-1}})), "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 835);
  Point point = locate ((struct _locate){p.x, p.y, p.z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 836 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"

  if (point.level < 0)
    { double _ret =  nodata; end_trace("interpolate", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 838);  return _ret; }
  { double _ret =  interpolate_linear (point, p); end_trace("interpolate", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 839);  return _ret; }
 end_trace("interpolate", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 840); }


void interpolate_array (scalar * list, coord * a, int n, double * v, bool linear)
{ trace ("interpolate_array", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 844);
  boundary_internal ((scalar *)(list), "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 845);
  int j = 0;
  for (int i = 0; i < n; i++) {
    Point point = locate ((struct _locate){a[i].x, a[i].y, a[i].z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 848 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
 ...
 v[j++] = nodata;
  ...
  MPI_MIN, 0, MPI_COMM_WORLD);
#endif
 end_trace("interpolate_array", "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 867); }
...
static double periodic_bc (Point point, Point neighbor, scalar s, void * data)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 899 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
void periodic (int dir)
{
    ...
    if (!(dir <= bottom)) qassert ("/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h", 924, "dir <= bottom");
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 937 "/home1/06342/tg856416/basilisk/src/grid/cartesian-common.h"
...
#line 4 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 27 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 35 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 43 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 61 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 66 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 78 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 81 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 90 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
 {
       { foreach_child()
...
#line 104 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 111 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 115 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
 {
      _attribute[s.i].prolongation (point, s);
       { foreach_child()
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 125 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 140 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 143 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 154 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 175 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 188 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 194 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 206
  ...
  if (!(fabs(sum) < 1e-10)) qassert ("/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h", 210, "fabs(sum) < 1e-10");
 }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
...
#line 206
  ...
  IF (!(fabs(sum) < 1e-10)) _stencil_qassert (__FILE__,__LINE__,"/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h", 210, "fabs(sum) < 1e-10");
 }
strongif (is_constant(cm)) {
const double _const_cm = _constant[cm.i -_NVARMAX];
NOT_UNUSED(_const_cm);
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 214 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 220 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 251 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
  ...
  if (point.level > 0) {
    ...
    FILE * fp = fopen (name, "w");
#line 271 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 302 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
    fclose (fp);
  }
  ...
  if (is_coarse()) {
    ...
    FILE * fp = fopen (name, "w");
#line 324 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 362 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
    fclose (fp);
  }
  fflush (ferr);
  fclose (plot);
...
#line 389 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
 {
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h", .line = 428,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 428 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
...
#line 437 "/home1/06342/tg856416/basilisk/src/grid/multigrid-common.h"
 {
      double sum = !leaves;
       { foreach_child()
...
#line 826 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
...
#line 1 "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h"
...
#line 21 "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h"
...
#line 42 "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h"
...
{ trace ("mpi_boundary_level", "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 52);
  scalar * list1 = NULL;
  strongif (list) for (scalar s = *list, *_i47 = list; ((scalar *)&s)->i >= 0; s = *++_i47)
    if (!is_constant(s) && _attribute[s.i].block > 0)
      list1 = list_add (list1, s);
  if (!list1)
    { ; end_trace("mpi_boundary_level", "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 58);  return; }
...
#line 65
 {
  ...
  prof_stop();
 end_trace("mpi_boundary_level", "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 85); }
...
{ trace ("z_indexing", "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 134);
  long i;
  if (leaves)
    i = pid()*(1 << 2*depth());
  else
...
#line 140 "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h"
 {
  ...
  boundary_internal ((scalar *)(((scalar []){index,{-1}})), "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 146);
  { double _ret =  pid() == 0 ? i*npe() - 1 : -1; end_trace("z_indexing", "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 147);  return _ret; }
 end_trace("z_indexing", "/home1/06342/tg856416/basilisk/src/grid/multigrid-mpi.h", 148); }
#line 900 "/home1/06342/tg856416/basilisk/src/grid/multigrid.h"
#line 6 "field_PM.c"
#line 1 "view.h"
#line 1 "/home1/06342/tg856416/basilisk/src/view.h"
#line 67 "/home1/06342/tg856416/basilisk/src/view.h"
#line 1 "gl/framebuffer.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gl/framebuffer.h"
...
#line 68 "/home1/06342/tg856416/basilisk/src/view.h"
#line 1 "gl/trackball.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gl/trackball.h"
#line 50 "/home1/06342/tg856416/basilisk/src/gl/trackball.h"
void gl_trackball 
(float q[4], float p1x, float p1y, float p2x, float p2y);
#line 61 "/home1/06342/tg856416/basilisk/src/gl/trackball.h"
void gl_add_quats 
(float *q1, float *q2, float *dest);





void gl_build_rotmatrix 
(float m[4][4], float q[4]);
...
void gl_axis_to_quat 
(float a[3], float phi, float q[4]);
#line 69 "/home1/06342/tg856416/basilisk/src/view.h"
#line 1 "gl/utils.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gl/utils.h"
...
#line 1 "gl/parser.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gl/parser.h"
...
#line 36 "/home1/06342/tg856416/basilisk/src/gl/utils.h"
#line 70 "/home1/06342/tg856416/basilisk/src/view.h"


#line 1 "utils.h"
#line 1 "/home1/06342/tg856416/basilisk/src/utils.h"
...
{ double n = _n; NOT_UNUSED(n);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/utils.h", .line = 69,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 69 "/home1/06342/tg856416/basilisk/src/utils.h"
...
{ double max = _max; NOT_UNUSED(max);
 ...
 double volume = _volume; NOT_UNUSED(volume);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/utils.h", .line = 135,
    .each = "foreach", .first = _first_call
  };
...
#line 136 "/home1/06342/tg856416/basilisk/src/utils.h"
...
{ double sum = _sum; NOT_UNUSED(sum);
 ...
 double min = _min; NOT_UNUSED(min);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/utils.h", .line = 163,
    .each = "foreach", .first = _first_call
  };
...
#line 164 "/home1/06342/tg856416/basilisk/src/utils.h"
...
#line 187 "/home1/06342/tg856416/basilisk/src/utils.h"
...
#line 213 "/home1/06342/tg856416/basilisk/src/utils.h"
double theta = 1.3;
...
#line 237 "/home1/06342/tg856416/basilisk/src/utils.h"
void gradients (scalar * f, vector * g)
{
  if (!(list_len(f) == vectors_len(g))) qassert ("/home1/06342/tg856416/basilisk/src/utils.h", 239, "list_len(f) == vectors_len(g)");
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/utils.h", .line = 240,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 240 "/home1/06342/tg856416/basilisk/src/utils.h"
 {
    scalar s; vector v;
...
#line 269 "/home1/06342/tg856416/basilisk/src/utils.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/utils.h", .line = 271,
    .each = "foreach", .first = _first_call
  };
...
#line 271 "/home1/06342/tg856416/basilisk/src/utils.h"
...
{ double max = _max; NOT_UNUSED(max);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/utils.h", .line = 285,
    .each = "foreach", .first = _first_call
  };
...
#line 285 "/home1/06342/tg856416/basilisk/src/utils.h"
 {
...
#define foreach_segment(_S,_p) {\
  ...
  if (!(norm > 0.)) qassert ("/home1/06342/tg856416/basilisk/src/utils.h", 331, "norm > 0.");\
...
#line 1 "output.h"
#line 1 "/home1/06342/tg856416/basilisk/src/output.h"
#line 37 "/home1/06342/tg856416/basilisk/src/output.h"
struct OutputField {
  scalar * list;
  FILE * fp;
  int n;
...
{ trace ("output_field", "/home1/06342/tg856416/basilisk/src/output.h", 47);
  ...
  boundary_internal ((scalar *)(p.list), "/home1/06342/tg856416/basilisk/src/output.h", 58);
...
#line 73 "/home1/06342/tg856416/basilisk/src/output.h"
 ...
 fputc ('\n', p.fp);
  ...
  matrix_free (field);
 end_trace("output_field", "/home1/06342/tg856416/basilisk/src/output.h", 113); }
#line 141 "/home1/06342/tg856416/basilisk/src/output.h"
struct OutputMatrix {
  scalar f;
  FILE * fp;
  int n;
...
{ trace ("output_matrix", "/home1/06342/tg856416/basilisk/src/output.h", 150);
  if (p.n == 0) p.n = N;
  if (!p.fp) p.fp = fout;
  if (p.linear) {
    scalar f = p.f;
    boundary_internal ((scalar *)(((scalar []){f,{-1}})), "/home1/06342/tg856416/basilisk/src/output.h", 155);
  }
  float fn = p.n;
...
#line 172 "/home1/06342/tg856416/basilisk/src/output.h"

 if (!(point.level >= 0)) qassert ("/home1/06342/tg856416/basilisk/src/output.h", 173, "point.level >= 0");
 v = val(p.f,0,0,0);
      }
  ...
  fflush (p.fp);
 end_trace("output_matrix", "/home1/06342/tg856416/basilisk/src/output.h", 180); }
#line 189 "/home1/06342/tg856416/basilisk/src/output.h"
        ...
        double val, double min, double max)
{
  ...
  if (!(i < 127 - 1)) qassert ("/home1/06342/tg856416/basilisk/src/output.h", 321, "i < NCMAP - 1");
  unsigned char * c1 = (unsigned char *) &c;
  for (int j = 0; j < 3; j++)
    c1[j] = 255*(cmap[i][j]*(1. - coef) + cmap[i + 1][j]*coef);
  return c;
}
#line 340 "/home1/06342/tg856416/basilisk/src/output.h"
...
{
  if (!(pid() == 0)) qassert ("/home1/06342/tg856416/basilisk/src/output.h", 422, "pid() == 0");
  const char * ext;
...
{
  if (!(pid() == 0)) qassert ("/home1/06342/tg856416/basilisk/src/output.h", 496, "pid() == 0");
...
#line 571 "/home1/06342/tg856416/basilisk/src/output.h"
struct OutputPPM {
  scalar f;
  FILE * fp;
  int n;
...
{ trace ("output_ppm", "/home1/06342/tg856416/basilisk/src/output.h", 586);
  ...
  if (p.linear) {
    ...
    if (mask.i)
      boundary_internal ((scalar *)(((scalar []){f,mask,{-1}})), "/home1/06342/tg856416/basilisk/src/output.h", 608);
    else
      boundary_internal ((scalar *)(((scalar []){f,{-1}})), "/home1/06342/tg856416/basilisk/src/output.h", 610);
  }
...
#line 636 "/home1/06342/tg856416/basilisk/src/output.h"
  ...
  v = val(p.f,0,0,0);
     ...
     Point point = locate ((struct _locate){xp, yp, p.z});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 646 "/home1/06342/tg856416/basilisk/src/output.h"
  ...
  matrix_free (ppm);
 end_trace("output_ppm", "/home1/06342/tg856416/basilisk/src/output.h", 678); }
#line 710 "/home1/06342/tg856416/basilisk/src/output.h"
struct OutputGRD {
  scalar f;
  FILE * fp;
  double Delta;
...
{ trace ("output_grd", "/home1/06342/tg856416/basilisk/src/output.h", 721);
  ...
  if (p.linear) {
    scalar f = p.f, mask = p.mask;
    if (mask.i)
      boundary_internal ((scalar *)(((scalar []){f,mask,{-1}})), "/home1/06342/tg856416/basilisk/src/output.h", 733);
    else
      boundary_internal ((scalar *)(((scalar []){f,{-1}})), "/home1/06342/tg856416/basilisk/src/output.h", 735);
  }
 ...
 if (p.linear) {
   ...
   Point point = locate ((struct _locate){xp, yp});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 764 "/home1/06342/tg856416/basilisk/src/output.h"
 ...
 Point point = locate ((struct _locate){xp, yp});  int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 774 "/home1/06342/tg856416/basilisk/src/output.h"
 ...
 fprintf (p.fp, "%f ", v);
  ...
  fflush (p.fp);
 end_trace("output_grd", "/home1/06342/tg856416/basilisk/src/output.h", 786); }
#line 813 "/home1/06342/tg856416/basilisk/src/output.h"
struct OutputGfs {
  FILE * fp;
  scalar * list;
  double t;
...
{ trace ("output_gfs", "/home1/06342/tg856416/basilisk/src/output.h", 843);
  char * fname = p.file;
...
#line 921 "/home1/06342/tg856416/basilisk/src/output.h"
 {
#if 1
    if (is_local(cell))
#endif
 ...
 3;
#line 951 "/home1/06342/tg856416/basilisk/src/output.h"
      if (is_leaf(cell))
 flags |= (1 << 4);
...
#endif
 end_trace("output_gfs", "/home1/06342/tg856416/basilisk/src/output.h", 1019); }
#line 1043 "/home1/06342/tg856416/basilisk/src/output.h"
struct Dump {
  char * file;
  scalar * list;
  FILE * fp;
...
{ trace ("dump", "/home1/06342/tg856416/basilisk/src/output.h", 1097);
  FILE * fp = p.fp;
  ...
  if (!(fp)) qassert ("/home1/06342/tg856416/basilisk/src/output.h", 1112, "fp");
...
#line 1123 "/home1/06342/tg856416/basilisk/src/output.h"
 {
 ...
 delete (((scalar []){size,{-1}}));  end_trace("dump", "/home1/06342/tg856416/basilisk/src/output.h", 1145); }
#else

void dump (struct Dump p)
{ trace ("dump", "/home1/06342/tg856416/basilisk/src/output.h", 1149);
  FILE * fp = p.fp;
  char def[] = "dump", * file = p.file ? p.file : p.fp ? NULL : def;
...
#line 1195 "/home1/06342/tg856416/basilisk/src/output.h"
 {
 ...
 fwrite (&val(s,0,0,0), 1, sizeof(double), fh);
  ...
  if (!p.unbuffered && pid() == 0)
    rename (name, file);
 delete (((scalar []){size,{-1}}));  end_trace("dump", "/home1/06342/tg856416/basilisk/src/output.h", 1219); }
#endif


bool restore (struct Dump p)
{ trace ("restore", "/home1/06342/tg856416/basilisk/src/output.h", 1224);
  FILE * fp = p.fp;
  char * file = p.file;
  if (file && (fp = fopen (file, "r")) == NULL)
    { bool _ret =  false; end_trace("restore", "/home1/06342/tg856416/basilisk/src/output.h", 1228);  return _ret; }
  if (!(fp)) qassert ("/home1/06342/tg856416/basilisk/src/output.h", 1229, "fp");
...
#line 1246 "/home1/06342/tg856416/basilisk/src/output.h"
  if (header.npe != npe()) {
    fprintf (ferr,
...
#line 1343 "/home1/06342/tg856416/basilisk/src/output.h"
 {
    unsigned flags;
 ...
 val(s,0,0,0) = val;
  ...
  { bool _ret =  true; end_trace("restore", "/home1/06342/tg856416/basilisk/src/output.h", 1389);  return _ret; }
 end_trace("restore", "/home1/06342/tg856416/basilisk/src/output.h", 1390); }
#line 376 "/home1/06342/tg856416/basilisk/src/utils.h"
#line 73 "/home1/06342/tg856416/basilisk/src/view.h"
#line 1 "input.h"
#line 1 "/home1/06342/tg856416/basilisk/src/input.h"
#line 16 "/home1/06342/tg856416/basilisk/src/input.h"
struct InputPGM {
...
{ int width = _width; NOT_UNUSED(width);
 ...
 int maxval = _maxval; NOT_UNUSED(maxval);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/input.h", .line = 73,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 73 "/home1/06342/tg856416/basilisk/src/input.h"
 {
 ...
 if (width != _width)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 73, "width");
 }
 if (_first_call) {
 if (height != _height)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 73, "height");
 }
 if (_first_call) {
 for (int i = 0; i < (10*sizeof(char)); i++)
   if (((char *)_a)[i] != 0) {
     reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 73, "a");
     break; }
 }
 if (_first_call) {
 if (maxval != _maxval)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 73, "maxval");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ int width = _width; NOT_UNUSED(width);
 ...
 int maxval = _maxval; NOT_UNUSED(maxval);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/input.h", .line = 96,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 96 "/home1/06342/tg856416/basilisk/src/input.h"
 {
      int i = (x - p.ox)*width/p.width, j = (y - p.oy)*width/p.width;
      IF (i >= 0 && i < width && j >= 0 && j < height)
 _stencil_val(__FILE__,__LINE__,s,0,0,0) = 1. - a[(height - 1 - j)*width + i]/(double)maxval;
 ...
 if (width != _width)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 96, "width");
 }
 if (_first_call) {
 if (height != _height)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 96, "height");
 }
 if (_first_call) {
 for (int i = 0; i < (10*sizeof(short)); i++)
   if (((char *)_a)[i] != 0) {
     reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 96, "a");
     break; }
 }
 if (_first_call) {
 if (maxval != _maxval)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/input.h", 96, "maxval");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 166 "/home1/06342/tg856416/basilisk/src/input.h"

void input_gfs (struct OutputGfs p)
{ trace ("input_gfs", "/home1/06342/tg856416/basilisk/src/input.h", 168);
  not_mpi_compatible();
...
#line 273 "/home1/06342/tg856416/basilisk/src/input.h"
 {
    unsigned flags;
 ...
 if (_attribute[s.i].v.x.i >= 0) {
  ...
  while (t < t1 && events (false))
    t = tnext;
  events (false);
 end_trace("input_gfs", "/home1/06342/tg856416/basilisk/src/input.h", 332); }
#line 371 "/home1/06342/tg856416/basilisk/src/input.h"
struct InputGRD {
  scalar s;
  FILE * fp;
  char * file;
...
{ double XG0 = _XG0; NOT_UNUSED(XG0);
 ...
 bool warning = _warning; NOT_UNUSED(warning);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/input.h", .line = 478,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 478 "/home1/06342/tg856416/basilisk/src/input.h"
 {
...
#line 74 "/home1/06342/tg856416/basilisk/src/view.h"
...
{
  if (!(_view)) qassert ("/home1/06342/tg856416/basilisk/src/view.h", 237, "_view");
  bview_destroy (_view);
}
...
#line 329 "/home1/06342/tg856416/basilisk/src/view.h"
typedef struct {
  GLubyte a[4];
} RGBA;
...
{ trace ("compose_image", "/home1/06342/tg856416/basilisk/src/view.h", 344);
  ...
  { pointer _ret =  image; end_trace("compose_image", "/home1/06342/tg856416/basilisk/src/view.h", 360);  return _ret; }
 end_trace("compose_image", "/home1/06342/tg856416/basilisk/src/view.h", 361); }
#line 419 "/home1/06342/tg856416/basilisk/src/view.h"
#line 1 "vertexbuffer.h"
#line 1 "/home1/06342/tg856416/basilisk/src/vertexbuffer.h"
#line 14 "/home1/06342/tg856416/basilisk/src/vertexbuffer.h"
struct {
...
static void vertex_buffer_glEnd ()
{
 ...
 vertex_buffer_push_index (i + 1);
    ...
    if (VertexBuffer.type >= 0 && type >= 0) {
      ...
      if (!(VertexBuffer.type == type)) qassert ("/home1/06342/tg856416/basilisk/src/vertexbuffer.h", 179, "VertexBuffer.type == type");
    }
    else
...
#line 420 "/home1/06342/tg856416/basilisk/src/view.h"
...
#line 1 "draw.h"
#line 1 "/home1/06342/tg856416/basilisk/src/draw.h"




#line 1 "fractions.h"
#line 1 "/home1/06342/tg856416/basilisk/src/fractions.h"
#line 12 "/home1/06342/tg856416/basilisk/src/fractions.h"
#line 1 "geometry.h"
#line 1 "/home1/06342/tg856416/basilisk/src/geometry.h"
#line 28 "/home1/06342/tg856416/basilisk/src/geometry.h"
...
#line 133 "/home1/06342/tg856416/basilisk/src/geometry.h"
...
#line 237 "/home1/06342/tg856416/basilisk/src/geometry.h"
...
#line 262 "/home1/06342/tg856416/basilisk/src/geometry.h"
...
#line 352 "/home1/06342/tg856416/basilisk/src/geometry.h"
...
#line 482 "/home1/06342/tg856416/basilisk/src/geometry.h"
...
#line 13 "/home1/06342/tg856416/basilisk/src/fractions.h"
...
#line 1 "myc2d.h"
#line 1 "/home1/06342/tg856416/basilisk/src/myc2d.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 7 "/home1/06342/tg856416/basilisk/src/myc2d.h"
...
#line 20 "/home1/06342/tg856416/basilisk/src/fractions.h"
#line 121 "/home1/06342/tg856416/basilisk/src/fractions.h"
struct Fractions {
  scalar Phi;
  scalar c;
  vector s;
...
{ trace ("fractions", "/home1/06342/tg856416/basilisk/src/fractions.h", 130);
  scalar Phi = a.Phi;
  scalar c = a.c;
  vector s = (a.s).x.i ? (a.s) : new_face_vector("s");
  double val = a.val;
#line 145 "/home1/06342/tg856416/basilisk/src/fractions.h"
  vector p;
  p.x = s.y; p.y = s.x;
#line 155 "/home1/06342/tg856416/basilisk/src/fractions.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _val = val;
{ double val = _val; NOT_UNUSED(val);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/fractions.h", .line = 155,
...
#line 180 "/home1/06342/tg856416/basilisk/src/fractions.h"
...
#line 182
 if (_first_call) {
 if (val != _val)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/fractions.h", 155, "val");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 182
 end_foreach_face(); }
#line 205 "/home1/06342/tg856416/basilisk/src/fractions.h"
  scalar s_z = c;
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _val = val;
{ double val = _val; NOT_UNUSED(val);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/fractions.h", .line = 206,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 206 "/home1/06342/tg856416/basilisk/src/fractions.h"


  {
#line 240 "/home1/06342/tg856416/basilisk/src/fractions.h"
    coord n;
    double nn = 0.;
    {
#line 242
...
#line 283 "/home1/06342/tg856416/basilisk/src/fractions.h"
      IF (ni == 0)
 ...
 if (val != _val)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/fractions.h", 206, "val");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 347 "/home1/06342/tg856416/basilisk/src/fractions.h"
 { strongif (!(a.s).x.i) delete (((scalar []){s.x,s.y,{-1}})); }  end_trace("fractions", "/home1/06342/tg856416/basilisk/src/fractions.h", 347); }
#line 391 "/home1/06342/tg856416/basilisk/src/fractions.h"
coord youngs_normal (Point point, scalar c)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 392 "/home1/06342/tg856416/basilisk/src/fractions.h"

  coord n;
  double nn = 0.;
  if (!(2 == 2)) qassert ("/home1/06342/tg856416/basilisk/src/fractions.h", 395, "dimension == 2");
  {
#line 396
 {
...
#line 392 "/home1/06342/tg856416/basilisk/src/fractions.h"
  ...
  coord n;
  double nn = 0.;
  IF (!(2 == 2)) _stencil_qassert (__FILE__,__LINE__,"/home1/06342/tg856416/basilisk/src/fractions.h", 395, "dimension == 2");
  {
#line 396
 {
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 415 "/home1/06342/tg856416/basilisk/src/fractions.h"
...
#line 441 "/home1/06342/tg856416/basilisk/src/fractions.h"

void reconstruction (const scalar c, vector n, scalar alpha)
{ trace ("reconstruction", "/home1/06342/tg856416/basilisk/src/fractions.h", 443);
   { 
#define mycs _mycs
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/fractions.h", .line = 444,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 444 "/home1/06342/tg856416/basilisk/src/fractions.h"
 {
...
#line 485 "/home1/06342/tg856416/basilisk/src/fractions.h"
 end_trace("reconstruction", "/home1/06342/tg856416/basilisk/src/fractions.h", 485); }
#line 505 "/home1/06342/tg856416/basilisk/src/fractions.h"
struct OutputFacets {
  scalar c;
  FILE * fp;
  vector s;
...
{ trace ("output_facets", "/home1/06342/tg856416/basilisk/src/fractions.h", 513);
  scalar c = p.c;
  vector s = p.s;
  if (!p.fp) p.fp = fout;
  if (!s.x.i) s.x.i = -1;
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/fractions.h", .line = 519,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 519 "/home1/06342/tg856416/basilisk/src/fractions.h"
...
#line 538 "/home1/06342/tg856416/basilisk/src/fractions.h"
    } } end_foreach_stencil();  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
#undef facet_normal
...
#line 538 "/home1/06342/tg856416/basilisk/src/fractions.h"
  ...
  fflush (p.fp);
 end_trace("output_facets", "/home1/06342/tg856416/basilisk/src/fractions.h", 541); }
...
{ trace ("interface_area", "/home1/06342/tg856416/basilisk/src/fractions.h", 551);
  double area = 0.;
   { 
#define mycs _mycs
disable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double area = _area; NOT_UNUSED(area);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/fractions.h", .line = 553,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 553 "/home1/06342/tg856416/basilisk/src/fractions.h"
...
#line 558
  ...
  { double _ret =  area; end_trace("interface_area", "/home1/06342/tg856416/basilisk/src/fractions.h", 559);  return _ret; }
 end_trace("interface_area", "/home1/06342/tg856416/basilisk/src/fractions.h", 560); }
#line 6 "/home1/06342/tg856416/basilisk/src/draw.h"
#line 1 "gl/font.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gl/font.h"
#line 27 "/home1/06342/tg856416/basilisk/src/gl/font.h"
#include <stdio.h>
#line 1 "gl/og_font.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gl/og_font.h"
...
#line 29 "/home1/06342/tg856416/basilisk/src/gl/font.h"
#line 39 "/home1/06342/tg856416/basilisk/src/gl/font.h"
extern SOG_StrokeFont ogStrokeMonoRoman;
#line 48 "/home1/06342/tg856416/basilisk/src/gl/font.h"
...
#line 83 "/home1/06342/tg856416/basilisk/src/gl/font.h"
...
#line 147 "/home1/06342/tg856416/basilisk/src/gl/font.h"
...
#line 226 "/home1/06342/tg856416/basilisk/src/gl/font.h"
...
#line 269 "/home1/06342/tg856416/basilisk/src/gl/font.h"
...
#line 321 "/home1/06342/tg856416/basilisk/src/gl/font.h"
...
#line 7 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 49 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _view_set {
  float tx, ty;
  float fov;
  float quat[4];
...
#line 240 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _mirror {
  coord n;
  double alpha;
};
...
#line 380 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 401 "/home1/06342/tg856416/basilisk/src/draw.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 407 "/home1/06342/tg856416/basilisk/src/draw.h"

  if (!(n)) qassert ("/home1/06342/tg856416/basilisk/src/draw.h", 408, "n");
  switch (n->type) {
 ...
 k[i] = evaluate_expression (point, n->e[i]);
  ...
  default:
    ...
    if (!(false)) qassert ("/home1/06342/tg856416/basilisk/src/draw.h", 456, "false");
  }
  return undefined;
...
#line 407 "/home1/06342/tg856416/basilisk/src/draw.h"
  ...
  IF (!(n)) _stencil_qassert (__FILE__,__LINE__,"/home1/06342/tg856416/basilisk/src/draw.h", 408, "n");
  switch (n->type) {
  case '1': return n->d.value;
  case '+': return (evaluate_expression (point, n->e[0]) +
      evaluate_expression(point, n->e[1]));
 ...
 k[i] = evaluate_expression (point, n->e[i]);
  ...
  default:
    ...
    IF (!(false)) _stencil_qassert (__FILE__,__LINE__,"/home1/06342/tg856416/basilisk/src/draw.h", 456, "false");
  }
  return undefined;
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/draw.h", .line = 536,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 536 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 605 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 662 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _draw_vof {
  char * c;
  char * s;
  bool edges;
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 684 "/home1/06342/tg856416/basilisk/src/draw.h"
...
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 732 "/home1/06342/tg856416/basilisk/src/draw.h"
...
{ trace ("draw_vof", "/home1/06342/tg856416/basilisk/src/draw.h", 743);
  scalar c = lookup_field (p.c);
  if (c.i < 0) {
    fprintf (ferr, "draw_vof(): no field named '%s'\n", p.c);
    { bool _ret =  false; end_trace("draw_vof", "/home1/06342/tg856416/basilisk/src/draw.h", 747);  return _ret; }
  }
  vector s = lookup_vector (p.s);

  scalar col = {-1}; if (p.color && strcmp (p.color, "level")) { col = compile_expression (p.color, &p.expr); if (col.i < 0) { bool _ret =  false; end_trace("draw_vof", "/home1/06342/tg856416/basilisk/src/draw.h", 751);  return _ret; } } double cmap[127][3]; if (p.color) { if (p.min == 0 && p.max == 0) { if (col.i < 0) p.min = 0, p.max = depth(); else { stats s = statsf (col); double avg = s.sum/s.volume; if (p.spread < 0.) p.min = s.min, p.max = s.max; else { if (!p.spread) p.spread = 5.; double spread = p.spread*s.stddev; p.min = avg - spread; p.max = avg + spread; } } } if (!p.map) p.map = jet; p.map (cmap); } if ((2 > 2 || p.linear) && !p.fc[0] && !p.fc[1] && !p.fc[2]) p.fc[0] = p.fc[1] = p.fc[2] = 1.; if (p.linear && col.i >= 0) boundary_internal ((scalar *)(((scalar []){col,{-1}})), "/home1/06342/tg856416/basilisk/src/draw.h", 751);;

  double cmin = 1e-3;
#line 763 "/home1/06342/tg856416/basilisk/src/draw.h"
  boundary_internal ((scalar *)(((scalar []){c,{-1}})), "/home1/06342/tg856416/basilisk/src/draw.h", 763);
...
#line 770 "/home1/06342/tg856416/basilisk/src/draw.h"
 {
...
#line 829 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 899 "/home1/06342/tg856416/basilisk/src/draw.h"
  if (p.expr) delete(((scalar []){col,{-1}}));
  { bool _ret =  true; end_trace("draw_vof", "/home1/06342/tg856416/basilisk/src/draw.h", 900);  return _ret; }
 end_trace("draw_vof", "/home1/06342/tg856416/basilisk/src/draw.h", 901); }
#line 912 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _isoline {
  char * phi;
  double val;
  int n;
...
{ trace ("isoline", "/home1/06342/tg856416/basilisk/src/draw.h", 934);

  if (!p.color) p.color = p.phi;
  scalar col = {-1}; if (p.color && strcmp (p.color, "level")) { col = compile_expression (p.color, &p.expr); if (col.i < 0) { bool _ret =  false; end_trace("isoline", "/home1/06342/tg856416/basilisk/src/draw.h", 937);  return _ret; } } double cmap[127][3]; if (p.color) { if (p.min == 0 && p.max == 0) { if (col.i < 0) p.min = 0, p.max = depth(); else { stats s = statsf (col); double avg = s.sum/s.volume; if (p.spread < 0.) p.min = s.min, p.max = s.max; else { if (!p.spread) p.spread = 5.; double spread = p.spread*s.stddev; p.min = avg - spread; p.max = avg + spread; } } } if (!p.map) p.map = jet; p.map (cmap); } if ((2 > 2 || p.linear) && !p.fc[0] && !p.fc[1] && !p.fc[2]) p.fc[0] = p.fc[1] = p.fc[2] = 1.; if (p.linear && col.i >= 0) boundary_internal ((scalar *)(((scalar []){col,{-1}})), "/home1/06342/tg856416/basilisk/src/draw.h", 937);;
  ...
  { bool _ret =  true; delete (((scalar []){siso.x,siso.y,fiso,{-1}}));  end_trace("isoline", "/home1/06342/tg856416/basilisk/src/draw.h", 957);  return _ret; }
 delete (((scalar []){siso.x,siso.y,fiso,{-1}}));  end_trace("isoline", "/home1/06342/tg856416/basilisk/src/draw.h", 958); }
#line 971 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _cells {
  coord n;
  double alpha;
  float lc[3], lw;
...
{ trace ("cells", "/home1/06342/tg856416/basilisk/src/draw.h", 979);
  bview * view = draw();
  { begin_draw_lines (view, p.lc, p.lw); {

     { foreach_visible (view){

#line 983 "/home1/06342/tg856416/basilisk/src/draw.h"
 {
...
#line 1005 "/home1/06342/tg856416/basilisk/src/draw.h"
  } end_draw_lines(); }
  { bool _ret =  true; end_trace("cells", "/home1/06342/tg856416/basilisk/src/draw.h", 1006);  return _ret; }
 end_trace("cells", "/home1/06342/tg856416/basilisk/src/draw.h", 1007); }
...
{ trace ("vectors", "/home1/06342/tg856416/basilisk/src/draw.h", 1022);
...
#line 1038 "/home1/06342/tg856416/basilisk/src/draw.h"
 ...
 view->ni++;
  ...
  { bool _ret =  true; end_trace("vectors", "/home1/06342/tg856416/basilisk/src/draw.h", 1057);  return _ret; }
 end_trace("vectors", "/home1/06342/tg856416/basilisk/src/draw.h", 1058); }
#line 1078 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _squares {
  char * color;
  char * z;
  double min, max, spread;
...
{ trace ("squares", "/home1/06342/tg856416/basilisk/src/draw.h", 1093);
  ...
  if (p.z) {
    ...
    if (Z.i < 0)
      { bool _ret =  false; end_trace("squares", "/home1/06342/tg856416/basilisk/src/draw.h", 1101);  return _ret; }
    n = new_vector("n");
     { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/draw.h", .line = 1103,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 1103 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 1104
    ...
    boundary_internal ((scalar *)((scalar *)((vector []){{n.x,n.y},{{-1},{-1}}})), "/home1/06342/tg856416/basilisk/src/draw.h", 1106);
  }

  scalar col = {-1}; if (p.color && strcmp (p.color, "level")) { col = compile_expression (p.color, &p.expr); if (col.i < 0) { bool _ret =  false; end_trace("squares", "/home1/06342/tg856416/basilisk/src/draw.h", 1109);  return _ret; } } double cmap[127][3]; if (p.color) { if (p.min == 0 && p.max == 0) { if (col.i < 0) p.min = 0, p.max = depth(); else { stats s = statsf (col); double avg = s.sum/s.volume; if (p.spread < 0.) p.min = s.min, p.max = s.max; else { if (!p.spread) p.spread = 5.; double spread = p.spread*s.stddev; p.min = avg - spread; p.max = avg + spread; } } } if (!p.map) p.map = jet; p.map (cmap); } if ((2 > 2 || p.linear) && !p.fc[0] && !p.fc[1] && !p.fc[2]) p.fc[0] = p.fc[1] = p.fc[2] = 1.; if (p.linear && col.i >= 0) boundary_internal ((scalar *)(((scalar []){col,{-1}})), "/home1/06342/tg856416/basilisk/src/draw.h", 1109);;
  scalar f = col;
...
#line 1119 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 1143 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 1194 "/home1/06342/tg856416/basilisk/src/draw.h"
    } end_colorized(); }
  }
  else {
...
#line 1200 "/home1/06342/tg856416/basilisk/src/draw.h"
 ...
 view->ni++;
    ...
    vertex_buffer_glEnd();
#line 1230 "/home1/06342/tg856416/basilisk/src/draw.h"
  }
  if (p.expr) delete (((scalar []){col,{-1}}));
  ...
  { bool _ret =  true; end_trace("squares", "/home1/06342/tg856416/basilisk/src/draw.h", 1236);  return _ret; }
 end_trace("squares", "/home1/06342/tg856416/basilisk/src/draw.h", 1237); }
#line 1248 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _box {
  bool notics;
  float lc[3], lw;
};
...
{ trace ("box", "/home1/06342/tg856416/basilisk/src/draw.h", 1255);
  bview * view = draw();
  { begin_draw_lines (view, p.lc, p.lw); {
 ...
 gl_StrokeString (label);
 glPopMatrix();
#line 1297 "/home1/06342/tg856416/basilisk/src/draw.h"
      }
      ...
      gl_StrokeString ("Y");
      glPopMatrix();
#line 1328 "/home1/06342/tg856416/basilisk/src/draw.h"
    }


     { foreach_level (0){

#line 1331 "/home1/06342/tg856416/basilisk/src/draw.h"
 {
      vertex_buffer_glBegin (GL_LINE_LOOP);
      glvertex2d (view, x - Delta_x/2., y - Delta_y/2.);
      glvertex2d (view, x + Delta_x/2., y - Delta_y/2.);
...
#line 1360 "/home1/06342/tg856416/basilisk/src/draw.h"
  } end_draw_lines(); }
  { bool _ret =  true; end_trace("box", "/home1/06342/tg856416/basilisk/src/draw.h", 1361);  return _ret; }
 end_trace("box", "/home1/06342/tg856416/basilisk/src/draw.h", 1362); }
#line 1375 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _isosurface {
  char * f;
  double v;
...
{ trace ("isosurface", "/home1/06342/tg856416/basilisk/src/draw.h", 1389);
#line 1450 "/home1/06342/tg856416/basilisk/src/draw.h"
  { bool _ret =  true; end_trace("isosurface", "/home1/06342/tg856416/basilisk/src/draw.h", 1450);  return _ret; }
 end_trace("isosurface", "/home1/06342/tg856416/basilisk/src/draw.h", 1451); }
#line 1461 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _travelling {
  double start, end;
...
#line 1508 "/home1/06342/tg856416/basilisk/src/draw.h"
struct _draw_string {
  char * str;
  int pos;
  float size;
...
{ trace ("draw_string", "/home1/06342/tg856416/basilisk/src/draw.h", 1517);
  bview * view = draw();
  ...
  { bool _ret =  true; end_trace("draw_string", "/home1/06342/tg856416/basilisk/src/draw.h", 1552);  return _ret; }
 end_trace("draw_string", "/home1/06342/tg856416/basilisk/src/draw.h", 1553); }
...
{ trace ("labels", "/home1/06342/tg856416/basilisk/src/draw.h", 1565);

  bool expr = false;
  scalar f = compile_expression (p.f, &expr);
  if (f.i < 0)
    { bool _ret =  false; end_trace("labels", "/home1/06342/tg856416/basilisk/src/draw.h", 1570);  return _ret; }
  bview * view = draw();
  float width = gl_StrokeWidth ('1'), height = gl_StrokeHeight();
  float res = view->res;
...
#line 1578 "/home1/06342/tg856416/basilisk/src/draw.h"
 ...
 glPopMatrix();
  ...
  { bool _ret =  true; end_trace("labels", "/home1/06342/tg856416/basilisk/src/draw.h", 1592);  return _ret; }




 end_trace("labels", "/home1/06342/tg856416/basilisk/src/draw.h", 1597); }
...
#line 1 "draw_json.h"
#line 1 "/home1/06342/tg856416/basilisk/src/draw_json.h"
...
#line 1606 "/home1/06342/tg856416/basilisk/src/draw.h"
...
#line 427 "/home1/06342/tg856416/basilisk/src/view.h"
#line 442 "/home1/06342/tg856416/basilisk/src/view.h"
struct _load {
  FILE * fp;
  char * file;
  Array * buf;
...
#line 496 "/home1/06342/tg856416/basilisk/src/view.h"
struct _save {
...
{ trace ("save", "/home1/06342/tg856416/basilisk/src/view.h", 516);
  char ppm[] = "ppm";
  if (!p.format) {
    p.format = ppm;
    if (p.file) {
 ...
 p.format = dot + 1;
  ...
  if (!strcmp (p.format, "png") ||
    ...
    if (pid() == 0) {
      ...
      if (!fp) {
 perror (p.file);
 { bool _ret =  false; end_trace("save", "/home1/06342/tg856416/basilisk/src/view.h", 542);  return _ret; }
      }
      gl_write_image (fp, image, view->width, view->height, view->samples);
      close_image (p.file, fp);
    }
    { bool _ret =  true; end_trace("save", "/home1/06342/tg856416/basilisk/src/view.h", 547);  return _ret; }
  }

  if (p.file && (p.fp = fopen (p.file, "w")) == NULL) {
    perror (p.file);
    { bool _ret =  false; end_trace("save", "/home1/06342/tg856416/basilisk/src/view.h", 552);  return _ret; }
  }
  if (!p.fp)
    p.fp = fout;
  ...
  if (!strcmp (p.format, "ppm")) {
    ...
    fprintf (ferr, "save(): error: the '%s' format is no longer supported\n",
      p.format);
#line 584 "/home1/06342/tg856416/basilisk/src/view.h"
  }
    ...
    { bool _ret =  false; end_trace("save", "/home1/06342/tg856416/basilisk/src/view.h", 604);  return _ret; }
  }
  ...
  { bool _ret =  true; end_trace("save", "/home1/06342/tg856416/basilisk/src/view.h", 611);  return _ret; }
 end_trace("save", "/home1/06342/tg856416/basilisk/src/view.h", 612); }
...
#line 1 "draw_get.h"
#line 1 "/home1/06342/tg856416/basilisk/src/draw_get.h"

#line 1 "parse.h"
#line 1 "/home1/06342/tg856416/basilisk/src/parse.h"
 ...
 nc++;
  ...
  case pint: case punsigned: case pbool: case pdouble: case pfloat:
    ...
    if (!p->n) {
      ...
      default: if (!(false)) qassert ("/home1/06342/tg856416/basilisk/src/parse.h", 77, "false");
      }
    }
    else {
      if (val[0] != '{') {
 ...
 *s++ = '\0';
 ...
 default: if (!(false)) qassert ("/home1/06342/tg856416/basilisk/src/parse.h", 104, "false");
 }
 val = s;
      }
      if (c != '}') {
 ...
 return false;
  ...
  default:
    if (!(false)) qassert ("/home1/06342/tg856416/basilisk/src/parse.h", 116, "false");
  }
  return true;
}
...
#line 3 "/home1/06342/tg856416/basilisk/src/draw_get.h"
...
#line 642 "/home1/06342/tg856416/basilisk/src/view.h"
...
#line 1 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 46 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 1 "./utils.h"
#line 47 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 87 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
static int defaults0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults0 (const int i, const double t, Event * _ev) { trace ("defaults0", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 87); 
{
  if (!(nl > 0)) qassert ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 89, "nl > 0");
 ...
 end_trace("defaults0", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 111); } return 0; } 

#line 1 "./run.h"
#line 1 "/home1/06342/tg856416/basilisk/src/run.h"
#line 9 "/home1/06342/tg856416/basilisk/src/run.h"
double dt = 1.;

#line 1 "./utils.h"
#line 12 "/home1/06342/tg856416/basilisk/src/run.h"


void run (void)
{ trace ("run", "/home1/06342/tg856416/basilisk/src/run.h", 15);
  iter = 0, t = 0., dt = 1.;
  init_grid (N);
  ...
  free_grid();
 end_trace("run", "/home1/06342/tg856416/basilisk/src/run.h", 37); }




static int defaults_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults (const int i, const double t, Event * _ev) { trace ("defaults", "/home1/06342/tg856416/basilisk/src/run.h", 42);  {
  display ((struct _display){"box();"});
 end_trace("defaults", "/home1/06342/tg856416/basilisk/src/run.h", 44); } return 0; } 





static int cleanup_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 1234567890);   *ip = i; *tp = t;   return ret; } static int cleanup (const int i, const double t, Event * _ev) { trace ("cleanup", "/home1/06342/tg856416/basilisk/src/run.h", 50);  {
  display ((struct _display){"", true});
 end_trace("cleanup", "/home1/06342/tg856416/basilisk/src/run.h", 52); } return 0; } 
#line 114 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"





static int defaults_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_0 (const int i, const double t, Event * _ev) { trace ("defaults_0", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 119); 
{
...
#line 135
 ...
 end_trace("defaults_0", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 154); } return 0; } 




static int init_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init (const int i, const double t, Event * _ev) { trace ("init", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 159); 
{
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 161,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 161 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
...
#line 161 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 ...
 end_trace("init", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 166); } return 0; } 
...
double dtmax;
static int set_dtmax_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int set_dtmax (const int i, const double t, Event * _ev) { trace ("set_dtmax", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 173);  dtmax = DT; end_trace("set_dtmax", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 173);  return 0; } 
#line 193 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
static bool hydrostatic = true;
vector hu, hf, ha;

static int face_fields_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int face_fields (const int i, const double t, Event * _ev) { trace ("face_fields", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 196); 
{
  hu = new_block_face_vector("hu", nl);
  hf = new_block_face_vector("hf", nl);
  ha = new_block_face_vector("ha", nl);
#line 209 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
{ double G = _G; NOT_UNUSED(G);
 ...
 double dtmax = _dtmax; NOT_UNUSED(dtmax);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 210,
    .each = "foreach_face", .first = _first_call
  };
...
#line 210 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
...
#line 260
 ...
 if (G != _G)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 210, "G");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 210, "dry");
 }
 if (_first_call) {
 if (pdt != _pdt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 210, "pdt");
 }
 if (_first_call) {
 if (CFL != _CFL)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 210, "CFL");
 }
 if (_first_call) {
 if (hydrostatic != _hydrostatic)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 210, "hydrostatic");
 }
 if (_first_call) {
 if (CFL_H != _CFL_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 210, "CFL_H");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 260
  ...
  pdt = dt = dtnext (dtmax);
 end_trace("face_fields", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 267); } return 0; } 
...
{ double dt = _dt; NOT_UNUSED(dt);
 ...
 int nl = _nl; NOT_UNUSED(nl);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 284,
    .each = "foreach_face", .first = _first_call
  };
...
#line 284 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 299 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 307
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 284, "dt");
 }
 if (_first_call) {
 if (CFL != _CFL)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 284, "CFL");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 284, "nl");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double dt = _dt; NOT_UNUSED(dt);
 double dry = _dry; NOT_UNUSED(dry);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 317,
    .each = "foreach_face", .first = _first_call
  };
foreach_face_stencil() { int ig = -1; VARIABLES;  strongif (is_stencil_face_x()) {
#line 317
...
#line 317 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
...
#line 335
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 317, "dt");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 317, "dry");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 341,
    .each = "foreach", .first = _first_call
  };
...
#line 341 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
...
#line 343
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 341, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 358 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
     { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _dt = dt;
 int __layer = _layer;
...
{ double dt = _dt; NOT_UNUSED(dt);
 ...
 double dry = _dry; NOT_UNUSED(dry);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 358,
    .each = "foreach", .first = _first_call
  };
...
#line 360
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 358, "dt");
 }
 if (_first_call) {
 if (_layer != __layer)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 358, "_layer");
 }
 if (_first_call) {
 if (t != _t)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 358, "t");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 358, "dry");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
static int half_advection_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int half_advection (const int i, const double t, Event * _ev) { trace ("half_advection", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 382); ; end_trace("half_advection", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 382);  return 0; } 




#line 1 "layered/diffusion.h"
#line 1 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
#line 31 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
void vertical_diffusion (Point point, scalar h, scalar s, double dt, double D,
    double dst, double s_b, double lambda_b)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 33 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
...
#line 56 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
  for (int l = 1; l < nl - 1; l++) {
    a[l] = - 2.*D*dt/(val(h,0,0,l-1) + val(h,0,0,l));
    c[l] = - 2.*D*dt/(val(h,0,0,l) + val(h,0,0,l+1));
    b[l] = val(h,0,0,l) - a[l] - c[l];
  }
#line 79 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
  a[nl-1] = - 2.*D*dt/(val(h,0,0,nl-2) + val(h,0,0,nl-1));
  b[nl-1] = val(h,0,0,nl-1) - a[nl-1];
  rhs[nl-1] += D*dt*dst;
#line 99 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
...
#line 133 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
double nu = 0.;
 vector lambda_b = {{_NVARMAX + 0},{_NVARMAX + 1}}, dut = {{_NVARMAX + 0},{_NVARMAX + 1}}, u_b = {{_NVARMAX + 0},{_NVARMAX + 1}};
#line 144 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
static int viscous_term_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int viscous_term (const int i, const double t, Event * _ev) { trace ("viscous_term", "/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 144); 
{
  if (nu > 0.) {
     { 
...
{ double dt = _dt; NOT_UNUSED(dt);
 ...
 double nu = _nu; NOT_UNUSED(nu);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/diffusion.h", .line = 147,
    .each = "foreach", .first = _first_call
  };
...
#line 147 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
 {
       { foreach_block_inner()
 {
#line 149
...
#line 155
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 147, "dt");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 147, "dry");
 }
 if (_first_call) {
 if (nu != _nu)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 147, "nu");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 155
 ...
 end_trace("viscous_term", "/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 159); } return 0; } 
#line 173 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/diffusion.h", .line = 178,
    .each = "foreach", .first = _first_call
  };
...
#line 178 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
 {
 scalar s, d2s;
...
{ double dry = _dry; NOT_UNUSED(dry);
 double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/diffusion.h", .line = 188,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 188 "/home1/06342/tg856416/basilisk/src/layered/diffusion.h"
 ...
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 188, "dry");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/diffusion.h", 188, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 388 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 396 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
static int acceleration_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration (const int i, const double t, Event * _ev) { trace ("acceleration", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 396); ; end_trace("acceleration", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 396);  return 0; } 

static int pressure_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int pressure (const int i, const double t, Event * _ev) { trace ("pressure", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 398); 
{
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 404,
    .each = "foreach_face", .first = _first_call
  };
foreach_face_stencil() { int ig = -1; VARIABLES;  strongif (is_stencil_face_x()) {
#line 404
...
#line 404 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 406
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 404, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double dt = _dt; NOT_UNUSED(dt);
 double dry = _dry; NOT_UNUSED(dry);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 411,
    .each = "foreach", .first = _first_call
  };
...
#line 411 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 413
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 411, "dt");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 411, "dry");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 413
 ...
 end_trace("pressure", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 432); } return 0; } 





static int update_eta_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int update_eta (const int i, const double t, Event * _ev) { trace ("update_eta", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 438); 
{
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 441,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 441 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
...
#line 441 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 ...
 end_trace("update_eta", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 447); } return 0; } 
...
static int remap_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int remap (const int i, const double t, Event * _ev) { trace ("remap", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 454); ; end_trace("remap", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 454);  return 0; } 
#line 466 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
static int cleanup_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 1234567890);   *ip = i; *tp = t;   return ret; } static int cleanup_0 (const int i, const double t, Event * _ev) { trace ("cleanup_0", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 466); 
{
  delete (((scalar []){eta,h,u.x,u.y,{-1}}));
  pfree (tracers,__func__,__FILE__,__LINE__), tracers = NULL;
 end_trace("cleanup_0", "/home1/06342/tg856416/basilisk/src/layered/hydro.h", 470); } return 0; } 
#line 484 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
double max_slope = 0.577350269189626;
#line 520 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
{ double dry = _dry; NOT_UNUSED(dry);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/hydro.h", .line = 522,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 522 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
...
#line 532
 ...
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/hydro.h", 522, "dry");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 547 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
double _radiation (Point point, double ref, scalar s)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 548 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 566 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 1 "./elevation.h"
#line 1 "/home1/06342/tg856416/basilisk/src/elevation.h"
#line 133 "/home1/06342/tg856416/basilisk/src/elevation.h"
void conserve_elevation (void) {}
#line 567 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 628 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 1 "./gauges.h"
#line 1 "/home1/06342/tg856416/basilisk/src/gauges.h"
#line 11 "/home1/06342/tg856416/basilisk/src/gauges.h"
typedef struct {
  char * name;
  double x, y;
  char * desc;
...
#line 629 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
#line 649 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
...
#line 655 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
 {
    double dl = 0.;
    {
#line 657
...
#line 692 "/home1/06342/tg856416/basilisk/src/layered/hydro.h"
typedef struct {
  char * name;
  coord s[2];
  char * desc;
...
#line 1 "layered/nh.h"
#line 1 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
#line 44 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
#line 1 "layered/implicit.h"
#line 1 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
#line 22 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
#line 1 "./poisson.h"
#line 1 "/home1/06342/tg856416/basilisk/src/poisson.h"
#line 32 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 55 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 65 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/poisson.h", .line = 84,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 84 "/home1/06342/tg856416/basilisk/src/poisson.h"
 {
    scalar s, ds;
...
#line 102 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 125 "/home1/06342/tg856416/basilisk/src/poisson.h"
struct MGSolve {
  scalar * a, * b;
...
{ double sum = _sum; NOT_UNUSED(sum);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/poisson.h", .line = 164,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 164 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 199 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 258 "/home1/06342/tg856416/basilisk/src/poisson.h"
struct Poisson {
  scalar a, b;
   vector alpha;
   scalar lambda;
...
#line 296 "/home1/06342/tg856416/basilisk/src/poisson.h"
  scalar c = a;
...
#line 303 "/home1/06342/tg856416/basilisk/src/poisson.h"
 {
...
#line 319 "/home1/06342/tg856416/basilisk/src/poisson.h"
      val(c,0,0,0) = n/d;
...
#line 338 "/home1/06342/tg856416/basilisk/src/poisson.h"
}
...
static double residual (scalar * al, scalar * bl, scalar * resl, void * data)
{
  ...
  double maxres = 0.;
#line 375 "/home1/06342/tg856416/basilisk/src/poisson.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double maxres = _maxres; NOT_UNUSED(maxres);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/poisson.h", .line = 375,
    .each = "foreach", .first = _first_call
  };
...
#line 402 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 460 "/home1/06342/tg856416/basilisk/src/poisson.h"
struct Project {
  vector uf;
  scalar p;
  vector alpha;
...
{ trace ("project", "/home1/06342/tg856416/basilisk/src/poisson.h", 470);
  vector uf = q.uf;
  scalar p = q.p;
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/poisson.h", .line = 483,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 483 "/home1/06342/tg856416/basilisk/src/poisson.h"
 {
...
#line 485
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/poisson.h", 483, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 499 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/poisson.h", .line = 505,
    .each = "foreach_face", .first = _first_call
  };
...
#line 505 "/home1/06342/tg856416/basilisk/src/poisson.h"
...
#line 506
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/poisson.h", 505, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 506
 end_foreach_face(); } }
  ...
  { mgstats _ret =  mgp; delete (((scalar []){div,{-1}}));  end_trace("project", "/home1/06342/tg856416/basilisk/src/poisson.h", 508);  return _ret; }
 delete (((scalar []){div,{-1}}));  end_trace("project", "/home1/06342/tg856416/basilisk/src/poisson.h", 509); }
#line 23 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"

mgstats mgH;
double theta_H = 0.5;
#line 34 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
static int defaults0_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults0_0 (const int i, const double t, Event * _ev) { trace ("defaults0_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 34); 
{
  if (CFL_H == 1e40)
    CFL_H = HUGE;
  mgH.nrelax = 4;
 end_trace("defaults0_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 39); } return 0; } 
#line 56 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"

static void relax_hydro (scalar * ql, scalar * rhsl, int lev, void * data)
{ trace ("relax_hydro", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 58);
...
#line 61 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
 {
...
#line 65
 ...
 end_trace("relax_hydro", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 72); }


static double residual_hydro (scalar * ql, scalar * rhsl,
         scalar * resl, void * data)
{ trace ("residual_hydro", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 77);
...
{ double G = _G; NOT_UNUSED(G);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/implicit.h", .line = 82,
    .each = "foreach_face", .first = _first_call
  };
...
#line 82 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
...
#line 83
 ...
 if (G != _G)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 82, "G");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double maxres = _maxres; NOT_UNUSED(maxres);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/implicit.h", .line = 85,
    .each = "foreach", .first = _first_call
  };
...
#line 85 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
 {
...
#line 91
  ...
  { double _ret =  maxres; delete (((scalar []){g.x,g.y,{-1}}));  end_trace("residual_hydro", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 93);  return _ret; }
 delete (((scalar []){g.x,g.y,{-1}}));  end_trace("residual_hydro", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 94); }
...
scalar rhs_eta;
vector alpha_eta;
#line 115 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
static int half_advection_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int half_advection_0 (const int i, const double t, Event * _ev) { trace ("half_advection_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 115);  {
  if (theta_H < 1.)
    advect (tracers, hu, hf, (1. - theta_H)*dt);
 end_trace("half_advection_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 118); } return 0; } 





static int acceleration_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int acceleration_0 (const int i, const double t, Event * _ev) { trace ("acceleration_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 124); 
{
...
{ double theta_H = _theta_H; NOT_UNUSED(theta_H);
 ...
 double C = _C; NOT_UNUSED(C);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/implicit.h", .line = 129,
    .each = "foreach_face", .first = _first_call
  };
...
#line 129 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
 {
...
#line 143
 ...
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 129, "theta_H");
 }
 if (_first_call) {
 if (G != _G)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 129, "G");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 129, "dry");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 129, "dt");
 }
 if (_first_call) {
 if (C != _C)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 129, "C");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 143
 end_foreach_face(); } }
#line 152 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
...
{ double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/implicit.h", .line = 153,
    .each = "foreach", .first = _first_call
  };
...
#line 153 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
 {
...
#line 155
 ...
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 153, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 176 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
 delete (((scalar []){su.x,su.y,{-1}}));  end_trace("acceleration_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 176); } return 0; } 
...
static int pressure_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int pressure_0 (const int i, const double t, Event * _ev) { trace ("pressure_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 184); 
{
...
#line 211 "/home1/06342/tg856416/basilisk/src/layered/implicit.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
{  double _theta_H = theta_H;
 double _G = G;
...
{ double theta_H = _theta_H; NOT_UNUSED(theta_H);
 ...
 double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/implicit.h", .line = 211,
    .each = "foreach_face", .first = _first_call
  };
...
#line 220
 ...
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 211, "theta_H");
 }
 if (_first_call) {
 if (G != _G)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 211, "G");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 211, "dry");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/implicit.h", 211, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 220
 end_foreach_face(); } }
 end_trace("pressure_0", "/home1/06342/tg856416/basilisk/src/layered/implicit.h", 221); } return 0; } 
#line 45 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
...
static int defaults_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_1 (const int i, const double t, Event * _ev) { trace ("defaults_1", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 56); 
{
  hydrostatic = false;
  mgp.nrelax = 4;

  if (!(nl > 0)) qassert ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 61, "nl > 0");
 ...
 end_trace("defaults_1", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 68); } return 0; } 
...
static int viscous_term_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int viscous_term_0 (const int i, const double t, Event * _ev) { trace ("viscous_term_0", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 76); 
{
  if (nu > 0.)
     { 
#define vertical_diffusion _vertical_diffusion
...
{ double dt = _dt; NOT_UNUSED(dt);
 double nu = _nu; NOT_UNUSED(nu);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/nh.h", .line = 79,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 79 "/home1/06342/tg856416/basilisk/src/layered/nh.h"

      vertical_diffusion (point, h, w, dt, nu, 0., 0., 0.); } end_foreach_stencil(); if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 79, "dt");
 }
 if (_first_call) {
 if (nu != _nu)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 79, "nu");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 79 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
 ...
 end_trace("viscous_term_0", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 81); } return 0; } 
#line 112 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
static void box_matrix (Point point, scalar phi, scalar rhs,
   vector hf, scalar eta,
   double * H, double * d)
{ int ig = 0; NOT_UNUSED(ig); int jg = 0; NOT_UNUSED(jg); POINT_VARIABLES; 
#line 115 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
...
#line 1 "./hessenberg.h"
#line 1 "/home1/06342/tg856416/basilisk/src/hessenberg.h"
#line 27 "/home1/06342/tg856416/basilisk/src/hessenberg.h"
static inline void givens (double x, double y, double * c, double * s)
{
#line 47 "/home1/06342/tg856416/basilisk/src/hessenberg.h"
...
#line 165 "/home1/06342/tg856416/basilisk/src/layered/nh.h"

vector hf;


static void relax_nh (scalar * phil, scalar * rhsl, int lev, void * data)
{ trace ("relax_nh", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 170);
...
#line 174 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
 {
#line 184 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
    double H[nl*nl], b[nl];
...
#line 211
 ...
 end_trace("relax_nh", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 218); }
...
static double residual_nh (scalar * phil, scalar * rhsl,
      scalar * resl, void * data)
{ trace ("residual_nh", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 226);
...
{ double theta_H = _theta_H; NOT_UNUSED(theta_H);
 ...
 int nl = _nl; NOT_UNUSED(nl);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/nh.h", .line = 232,
    .each = "foreach_face", .first = _first_call
  };
...
#line 232 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
 {
...
#line 238
 ...
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 232, "theta_H");
 }
 if (_first_call) {
 if (G != _G)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 232, "G");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 232, "dry");
 }
 if (_first_call) {
 if (max_slope != _max_slope)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 232, "max_slope");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 232, "nl");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double dry = _dry; NOT_UNUSED(dry);
 ...
 double maxres = _maxres; NOT_UNUSED(maxres);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/nh.h", .line = 240,
    .each = "foreach", .first = _first_call
  };
...
#line 240 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
 {
#line 254 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
    coord dz;
    {
#line 255
...
#line 289 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
    _stencil_val(__FILE__,__LINE__,res_eta,0,0,0) = _stencil_val(__FILE__,__LINE__,rhs_eta,0,0,0) - _stencil_val(__FILE__,__LINE__,eta,0,0,0);
     { foreach_block_inner()
      {
#line 291
...
#line 291
 ...
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 240, "dry");
 }
 if (_first_call) {
 if (max_slope != _max_slope)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 240, "max_slope");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 240, "nl");
 }
 if (_first_call) {
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 240, "theta_H");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 240, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 293
  ...
  { double _ret =  maxres; end_trace("residual_nh", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 296);  return _ret; }
 end_trace("residual_nh", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 297); }
...
static int pressure_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int pressure_1 (const int i, const double t, Event * _ev) { trace ("pressure_1", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 305); 
{
#line 350 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
...
{ double max_slope = _max_slope; NOT_UNUSED(max_slope);
 ...
 double v1 = _v1; NOT_UNUSED(v1);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/nh.h", .line = 352,
    .each = "foreach", .first = _first_call
  };
...
#line 352 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
 {
    coord dz;
    {
#line 354
...
#line 367
 ...
 if (max_slope != _max_slope)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 352, "max_slope");
 }
 if (_first_call) {
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 352, "theta_H");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 352, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double dry = _dry; NOT_UNUSED(dry);
 ...
 double dt = _dt; NOT_UNUSED(dt);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/nh.h", .line = 395,
    .each = "foreach_face", .first = _first_call
  };
...
#line 395 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
 {
...
#line 403
 ...
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 395, "dry");
 }
 if (_first_call) {
 if (max_slope != _max_slope)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 395, "max_slope");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 395, "nl");
 }
 if (_first_call) {
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 395, "theta_H");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 395, "dt");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 403
 end_foreach_face(); } }
#line 423 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double breaking = _breaking; NOT_UNUSED(breaking);
 ...
 double theta_H = _theta_H; NOT_UNUSED(theta_H);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/nh.h", .line = 423,
    .each = "foreach", .first = _first_call
  };
...
#line 448 "/home1/06342/tg856416/basilisk/src/layered/nh.h"
    {
#line 448
...
#line 448
 ...
 if (breaking != _breaking)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 423, "breaking");
 }
 if (_first_call) {
 if (G != _G)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 423, "G");
 }
 if (_first_call) {
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 423, "dry");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 423, "nl");
 }
 if (_first_call) {
 if (dt != _dt)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 423, "dt");
 }
 if (_first_call) {
 if (theta_H != _theta_H)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/nh.h", 423, "theta_H");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 448
 ...
 delete (((scalar []){su.x,su.y,{-1}}));  end_trace("pressure_1", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 451); } return 0; } 
...
static int cleanup_1_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 1234567890);   *ip = i; *tp = t;   return ret; } static int cleanup_1 (const int i, const double t, Event * _ev) { trace ("cleanup_1", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 458);  {
  delete (((scalar []){w,phi,{-1}}));
 end_trace("cleanup_1", "/home1/06342/tg856416/basilisk/src/layered/nh.h", 460); } return 0; } 
#line 10 "field_PM.c"
#line 1 "layered/remap.h"
#line 1 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
#line 11 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
#line 1 "./ppr/ppr.h"
#line 1 "/home1/06342/tg856416/basilisk/src/ppr/ppr.h"
#line 12 "/home1/06342/tg856416/basilisk/src/ppr/ppr.h"
#include <stdio.h>
#include <math.h>
#include <stdlib.h>

#line 34 "/home1/06342/tg856416/basilisk/src/ppr/ppr.h"
...
#line 12 "/home1/06342/tg856416/basilisk/src/layered/remap.h"


int edge_meth = 101, cell_meth = 202, cell_lim = 300;
#line 23 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
double * beta = NULL;

static int defaults_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int defaults_2 (const int i, const double t, Event * _ev) { trace ("defaults_2", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 25); 
{
  beta = pmalloc (nl*sizeof(double),__func__,__FILE__,__LINE__);
  for (int l = 0; l < nl; l++)
    beta[l] = 1./nl;
 end_trace("defaults_2", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 30); } return 0; } 
#line 41 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
...
{ trace ("vertical_remapping", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 58);
...
{ double dry = _dry; NOT_UNUSED(dry);
 ...
 int cell_lim = _cell_lim; NOT_UNUSED(cell_lim);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "/home1/06342/tg856416/basilisk/src/layered/remap.h", .line = 60,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 60 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
 {
#line 71 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
    double H = 0.;
     { foreach_block_inner()
 ...
 if (dry != _dry)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "dry");
 }
 if (_first_call) {
 if (npos != _npos)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "npos");
 }
 if (_first_call) {
 if (nvar != _nvar)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "nvar");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "nl");
 }
 if (_first_call) {
 for (int i = 0; i < (10*sizeof(double)); i++)
   if (((char *)_beta)[i] != 0) {
     reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "beta");
     break; }
 }
 if (_first_call) {
 if (ndof != _ndof)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "ndof");
 }
 if (_first_call) {
 if (edge_meth != _edge_meth)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "edge_meth");
 }
 if (_first_call) {
 if (cell_meth != _cell_meth)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "cell_meth");
 }
 if (_first_call) {
 if (cell_lim != _cell_lim)
   reduction_warning ("/home1/06342/tg856416/basilisk/src/layered/remap.h", 60, "cell_lim");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 71 "/home1/06342/tg856416/basilisk/src/layered/remap.h"
 ...
 end_trace("vertical_remapping", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 106); }




static int remap_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int remap_0 (const int i, const double t, Event * _ev) { trace ("remap_0", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 111);  {
  if (nl > 1)
    vertical_remapping (h, tracers);
 end_trace("remap_0", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 114); } return 0; } 




static int cleanup_2_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 1234567890);   *ip = i; *tp = t;   return ret; } static int cleanup_2 (const int i, const double t, Event * _ev) { trace ("cleanup_2", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 119); 
{
  pfree (beta,__func__,__FILE__,__LINE__), beta = NULL;
 end_trace("cleanup_2", "/home1/06342/tg856416/basilisk/src/layered/remap.h", 122); } return 0; } 
#line 11 "field_PM.c"

#line 1 "layered/perfs.h"
#line 1 "/home1/06342/tg856416/basilisk/src/layered/perfs.h"
...
static int perfs_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i += 1);   *ip = i; *tp = t;   return ret; } static int perfs (const int i, const double t, Event * _ev) { trace ("perfs", "/home1/06342/tg856416/basilisk/src/layered/perfs.h", 7);  {
  ...
  fflush (fp);
 end_trace("perfs", "/home1/06342/tg856416/basilisk/src/layered/perfs.h", 23); } return 0; } 
...
static int perf_plot_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 10);   *ip = i; *tp = t;   return ret; } static int perf_plot (const int i, const double t, Event * _ev) { trace ("perf_plot", "/home1/06342/tg856416/basilisk/src/layered/perfs.h", 30);  {
  if (getenv ("DISPLAY"))
    qpopen ("gnuplot -e 'set term x11 noraise title perfs' "
    "$BASILISK/layered/perfs.plot 2> /dev/null "
    "& read dummy; kill $!", "w");
 end_trace("perf_plot", "/home1/06342/tg856416/basilisk/src/layered/perfs.h", 35); } return 0; } 
#line 13 "field_PM.c"
...
{ _init_solver();
 ...
 free_solver(); }
#line 89 "field_PM.c"
static int init_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init_0 (const int i, const double t, Event * _ev) { trace ("init_0", "field_PM.c", 89); 
{
...
#line 97 "field_PM.c"
 ...
 if (h_ != _h_)
   reduction_warning ("field_PM.c", 97, "h_");
 }
 if (_first_call) {
 if (nl != _nl)
   reduction_warning ("field_PM.c", 97, "nl");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
#line 107 "field_PM.c"
 ...
 end_trace("init_0", "field_PM.c", 120); } return 0; } 
...
static int energy_before_remap_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int energy_before_remap (const int i, const double t, Event * _ev) { trace ("energy_before_remap", "field_PM.c", 127); 
{
  if (i==10) {
...
#line 144
  ...
  fflush (fp);
 end_trace("energy_before_remap", "field_PM.c", 148); } return 0; } 

static int energy_after_remap_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int energy_after_remap (const int i, const double t, Event * _ev) { trace ("energy_after_remap", "field_PM.c", 150); 
{
  if (i==10) {
...
#line 167
  ...
  fprintf (fp, "%g %g %g\n", t, ke/2., 9.8*gpe - gpe_base);
  fflush (fp);
 end_trace("energy_after_remap", "field_PM.c", 171); } return 0; } 





static int movie_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t += 0.1);   *ip = i; *tp = t;   return ret; } static int movie_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t <= TEND);   *ip = i; *tp = t;   return ret; } static int movie (const int i, const double t, Event * _ev) { trace ("movie", "field_PM.c", 177); 
{
  char s[80];
...
#line 190 "field_PM.c"
 {
  ...
  fclose (fuy);
 delete (((scalar []){slope,{-1}}));  end_trace("movie", "field_PM.c", 217); } return 0; } 
...
static int paraview_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = 100);   *ip = i; *tp = t;   return ret; } static int paraview_expr1 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t += 0.2);   *ip = i; *tp = t;   return ret; } static int paraview_expr2 (int * ip, double * tp, Event * _ev) {   int i = *ip; double t = *tp;   int ret = ( t <= TEND);   *ip = i; *tp = t;   return ret; } static int paraview (const int i, const double t, Event * _ev) { trace ("paraview", "field_PM.c", 224);  {
 ...
 end_trace("paraview", "field_PM.c", 251); } return 0; } 
#line 265 "field_PM.c"
static int endrun_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t = TEND);   *ip = i; *tp = t;   return ret; } static int endrun (const int i, const double t, Event * _ev) { trace ("endrun", "field_PM.c", 265);  {
  dump ((struct Dump){0});
 end_trace("endrun", "field_PM.c", 267); } return 0; } 
