...
#line 15 "stokes_ml_events-cpp.c"
#line 1 "stokes_ml_events.c"
#line 21 "stokes_ml_events.c"
...
#line 129 "stokes_ml_events.c"

static int init_0_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int init_0 (const int i, const double t, Event * _ev) { trace ("init_0", "stokes_ml_events.c", 130); 
{
...
{ int nl = _nl; NOT_UNUSED(nl);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "stokes_ml_events.c", .line = 134,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 134 "stokes_ml_events.c"
 {
 ...
 if (nl != _nl)
   reduction_warning ("stokes_ml_events.c", 134, "nl");
 }
  _first_call = false;
}}
enable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ {  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "stokes_ml_events.c", .line = 144,
    .each = "foreach", .first = _first_call
  };
foreach_stencil(){

#line 144 "stokes_ml_events.c"
 {
...
#line 144 "stokes_ml_events.c"
 ...
 end_trace("init_0", "stokes_ml_events.c", 161); } return 0; } 

static int limiter_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 0);   *ip = i; *tp = t;   return ret; } static int limiter (const int i, const double t, Event * _ev) { trace ("limiter", "stokes_ml_events.c", 163);  {
  gradient = minmod2;
  theta = 1;
 end_trace("limiter", "stokes_ml_events.c", 166); } return 0; } 
#line 178 "stokes_ml_events.c"
static int logfile_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i++);   *ip = i; *tp = t;   return ret; } static int logfile (const int i, const double t, Event * _ev) { trace ("logfile", "stokes_ml_events.c", 178); 
{
  double ke = 0., gpe = 0.;
   { 
disable_fpe (FE_DIVBYZERO|FE_INVALID);
...
{ double ke = _ke; NOT_UNUSED(ke);
 double gpe = _gpe; NOT_UNUSED(gpe);
  static bool _first_call = true;
  ForeachData _foreach_data = {
    .fname = "stokes_ml_events.c", .line = 181,
    .each = "foreach", .first = _first_call
  };
...
#line 191
  ...
  fflush (fp);
 end_trace("logfile", "stokes_ml_events.c", 195); } return 0; } 




static int movie_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t += 0.01*((2.*pi)/sqrt(1*(2.*pi))));   *ip = i; *tp = t;   return ret; } static int movie (const int i, const double t, Event * _ev) { trace ("movie", "stokes_ml_events.c", 200); 
{
  ...
  output_matrix_mpi ((struct OutputMatrix){w_temp, fuz, N, .linear = true});
  fclose (fuz);
 end_trace("movie", "stokes_ml_events.c", 238); } return 0; } 


static int field_log_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t += 0.1*((2.*pi)/sqrt(1*(2.*pi))));   *ip = i; *tp = t;   return ret; } static int field_log (const int i, const double t, Event * _ev) { trace ("field_log", "stokes_ml_events.c", 241);  {
  char *suffix = "matrix";
  writefields (t, suffix);
 end_trace("field_log", "stokes_ml_events.c", 244); } return 0; } 

static int snapshot_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (t += 0.1*((2.*pi)/sqrt(1*(2.*pi))));   *ip = i; *tp = t;   return ret; } static int snapshot (const int i, const double t, Event * _ev) { trace ("snapshot", "stokes_ml_events.c", 246);  {
  char dname[100];
  sprintf (dname, "dump%g", t/((2.*pi)/sqrt(1*(2.*pi))));
  dump ((struct Dump){dname});
 end_trace("snapshot", "stokes_ml_events.c", 250); } return 0; } 

static int end_expr0 (int * ip, double * tp, Event * _ev) {  int i = *ip; double t = *tp;  int ret = (i = 4);   *ip = i; *tp = t;   return ret; } static int end (const int i, const double t, Event * _ev) { trace ("end", "stokes_ml_events.c", 252);  {
  fprintf (fout, "i = %d t = %g\n", i, t);
  dump ((struct Dump){"end"});
 end_trace("end", "stokes_ml_events.c", 255); } return 0; } 
